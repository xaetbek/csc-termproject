var getNRecentPosts = require('../models/Posts').getNRecentPosts;
var getPostById = require('../models/Posts').getPostById;
const getCommentsForPost = require('../models/comments').getCommentsForPost;
